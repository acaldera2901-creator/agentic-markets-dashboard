...
const COPY = {
  it: {
    ...
    waKpi1Val: "Hit-rate", waKpi1Lab: "su pick concluse", waKpi2Lab: "prima del fischio", waKpi3Val: "Tracciato", waKpi3Lab: "CLV verificato",
    waCta: "Inizia gratis",
  ...
  en: {
    ...
    waKpi1Val: "Hit rate", waKpi1Lab: "on settled picks", waKpi2Lab: "logged pre-match", waKpi3Val: "Tracked", waKpi3Lab: "verified CLV",
    waCta: "Start free",
    waCtaSub: "No card",
    waColMatch: "Match", waReadModel: "Model", waReadMarket: "Market", waReadEdge: "Edge",
  ...
  es: {
    ...
    waKpi1Val: "Acierto", waKpi1Lab: "en apuestas cerradas", waKpi2Lab: "antes del partido", waKpi3Val: "Registrado", waKpi3Lab: "CLV verificado",
  ...
  fr: {
    ...
    waKpi1Val: "Réussite", waKpi1Lab: "sur paris clôturés", waKpi2Lab: "avant le match", waKpi3Val: "Suivi", waKpi3Lab: "CLV vérifié",
  ...
  ru: {
    ...
    waKpi1Val: "Точность", waKpi1Lab: "по закрытым прогнозам", waKpi2Lab: "до матча", waKpi3Val: "Отслеж.", waKpi3Lab: "проверенный CLV",
