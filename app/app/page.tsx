...
const BASE_TRANSLATIONS = {
  it: {
    ...
    auth_footer: "BetRedge Pro si paga con carta o crypto. I dati prediction restano bloccati finché il piano non è attivo.",
  ...
  en: {
    ...
    auth_create_btn: "Continue to plans",
    auth_footer: "BetRedge Pro takes card or crypto. Prediction data stays locked until the plan is active.",
...
const EXTRA_TRANSLATIONS = {
  es: {
    ...
    auth_footer: "BetRedge Pro se paga con tarjeta o cripto. Los datos de predicción permanecen bloqueados hasta que el plan esté activo.",
  ...
  fr: {
    ...
    auth_footer: "BetRedge Pro accepte carte ou crypto. Les données de prédiction restent verrouillées tant que le plan n'est pas actif.",
  ...
  ru: {
    ...
    auth_footer: "BetRedge Pro — оплата картой или криптой. Данные прогнозов остаются заблокированными, пока план не активен.",
