...
const COPY = {
  it: {
    ...
    cardLiveDesc: "Punteggi e stato live, con probabilità pre-partita congelate.",
    playNow: "VEDI ORA",
    ...
    cardTrackTag: "La prova", cardTrack: "Track record", cardTrackDesc: "Esiti delle pick concluse; lo storico include voci ricostruite o riclassificate.", cardTrackBtn: "Storico",
    ...
    waKpi1Val: "Hit-rate", waKpi1Lab: "su pick concluse", waKpi2Lab: "registro prospettico",
    waCta: "Inizia gratis",
    ...
    hwS5: "Registro", hwS5Desc: "Il registro prospettico ha timestamp; lo storico include anche voci ricostruite.",
  },
  en: {
    signin: "Sign In",
    register: "Register",
    ...
    cardLiveDesc: "Live scores and status, with frozen pre-match probabilities.",
    playNow: "VIEW NOW",
    cardApp: "BETREDGE APP",
    ...
    cardTrackTag: "The proof", cardTrack: "Track record", cardTrackDesc: "Settled pick results; history includes reconstructed or regraded entries.", cardTrackBtn: "History",
    ...
    waKpi1Val: "Hit rate", waKpi1Lab: "on settled picks", waKpi2Lab: "prospective ledger",
    waCta: "Start free",
    waCtaSub: "No card",
    waColMatch: "Match", waReadModel: "Model", waReadMarket: "Market", waReadEdge: "Edge",
    ...
    hwS5: "Record", hwS5Desc: "Prospective picks have timestamps; history also includes reconstructed entries.",
  },
  es: {
    signin: "Entrar",
    register: "Regístrate",
    ...
    cardLiveDesc: "Marcadores y estado en directo, con probabilidades prepartido fijas.",
    playNow: "VER AHORA",
    cardApp: "BETREDGE APP",
    ...
    cardTrackTag: "La prueba", cardTrack: "Track record", cardTrackDesc: "Resultados de picks cerrados; el historial incluye registros reconstruidos o revisados.", cardTrackBtn: "Historial",
    ...
    waKpi1Val: "Acierto", waKpi1Lab: "en apuestas cerradas", waKpi2Lab: "registro prospectivo",
    ...
    hwS5: "Registro", hwS5Desc: "El registro prospectivo tiene marcas de tiempo; el historial también incluye entradas reconstruidas.",
  },
  fr: {
    signin: "Se connecter",
    register: "S'inscrire",
    ...
    cardLiveDesc: "Scores et statut en direct, avec probabilités avant-match figées.",
    ...
    cardTrackTag: "La preuve", cardTrack: "Track record", cardTrackDesc: "Résultats des pronostics clôturés ; historique incluant des entrées reconstruites ou réévaluées.", cardTrackBtn: "Historique",
    ...
    waKpi1Val: "Réussite", waKpi1Lab: "sur paris clôturés", waKpi2Lab: "registre prospectif",
    ...
    hwS5: "Registre", hwS5Desc: "Le registre prospectif est horodaté ; l’historique inclut aussi des entrées reconstruites.",
  },
  ru: {
    signin: "Войти",
    ...
    cardLiveDesc: "Счёт и статус матча в реальном времени; предматчевые вероятности зафиксированы.",
    playNow: "СМОТРЕТЬ",
    cardApp: "BETREDGE APP",
    ...
    cardTrackTag: "Доказательство", cardTrack: "Track record", cardTrackDesc: "Результаты завершённых прогнозов; история включает восстановленные или пересмотренные записи.", cardTrackBtn: "История",
    ...
    waKpi1Val: "Точность", waKpi1Lab: "по закрытым прогнозам", waKpi2Lab: "перспективный реестр",
    ...
    hwS5: "Запись", hwS5Desc: "В перспективном реестре есть отметки времени; история также включает восстановленные записи.",
  },
} as const;
...
const V3_EN: V3Copy = {
  ...
  stripItems: ["Model probability", "Market-implied probability", "Edge", "Reasoning", "Prospective ledger timestamp", "Settled public result"],
  chipLogged: "Prospective ledger timestamps", chipCal: "Calibrated, not hyped",
  ...
  anNotes: [
    { lab: "Model lean", strong: "The side the model leans to, stated plainly.", body: "The outcome with the highest estimated probability. A narrow lead still carries uncertainty and is not a guarantee." },
  ...
  prEyebrow: "The proof", prHead: "The receipts come first.", prBadge: "HISTORY & PROSPECTIVE LEDGER",
  prMeta: (n) => `${n} settled readings. History includes reconstructed or regraded entries; distinguish these from timestamped prospective ledger picks. Past performance is not a forecast.`,
  prMetaQual: "History includes reconstructed or regraded entries alongside timestamped prospective ledger picks. Past results are not a forecast.",
  prWall: "PUBLIC RECORD", prColMatch: "MATCH", prColRes: "RESULT",
  prCta: "View the full record",
  prQuote: "The pick is the strongest estimated outcome, even when the probabilities are close. Read the uncertainty alongside the selection.",
  ...
  suItems: [
    ...
    { pk: "Build a Probability View", pn: "Combine markets on one fixture", p: "Stack markets across a fixture and watch the blended probability and implied edge recompute as you add legs.", ps: "combined estimate · ", psB: "per leg" },
    { pk: "Live Scores & Pre-match Probabilities", pn: "The board, as the match moves", p: "Scores and match status update during play. Pre-match model probabilities remain frozen; there is no automatic execution.", ps: "live · ", psB: "updating" },
  ],
  ...
  // Renewal conditions must be checked at checkout and in the account.
  pcNote: "Monthly or annual access · Check renewal conditions at checkout and in your account · No bookmaker account required · No bets placed for you · No guaranteed returns · 18+",
  ...
  pcFreeList: ["3 model readings per sport, every day", "Public results and prospective ledger", "Probability, market price and a preview of the edge", "No card required"],
  ...
  pcProList: ["Everything in Base, with no daily cap", "Deep analysis on every match card", "Live Scores & Pre-match Probabilities", "Build a Probability View"],
...
const V3_IT: V3Copy = {
  ...
  stripItems: ["Probabilità del modello", "Probabilità implicita del mercato", "Edge", "Ragionamento", "Timestamp del registro prospettico", "Esito pubblico concluso"],
  chipLogged: "Registro prospettico con timestamp", chipCal: "Calibrata, mai gonfiata",
  ...
  anNotes: [
    { lab: "Lean del modello", strong: "Il lato verso cui pende il modello, detto chiaro.", body: "L’esito con la probabilità stimata più alta. Anche un vantaggio minimo resta incerto e non è una garanzia." },
  ...
  prEyebrow: "La prova", prHead: "Prima vengono le ricevute.", prBadge: "STORICO E REGISTRO PROSPETTICO",
  prMeta: (n) => `${n} letture concluse. Lo storico include voci ricostruite o riclassificate, distinte dalle pick prospettiche con timestamp. I risultati passati non sono una previsione.`,
  prMetaQual: "Lo storico include voci ricostruite o riclassificate accanto alle pick prospettiche con timestamp. I risultati passati non sono una previsione.",
  prWall: "REGISTRO PUBBLICO", prColMatch: "MATCH", prColRes: "ESITO",
  prCta: "Vedi il registro completo",
  prQuote: "La pick è l’esito con la stima più alta, anche quando le probabilità sono vicine. Leggi l’incertezza insieme alla selezione.",
  ...
  suItems: [
    ...
    { pk: "Costruisci una vista di probabilità", pn: "Combina i mercati di una partita", p: "Sovrapponi mercati su una partita e guarda probabilità ed edge combinati ricalcolarsi mentre aggiungi selezioni.", ps: "stima combinata · ", psB: "per selezione" },
    { pk: "Punteggi live e probabilità pre-partita", pn: "Il board, mentre la partita si muove", p: "Punteggi e stato si aggiornano durante la partita. Le probabilità pre-partita del modello restano congelate; nessuna esecuzione automatica.", ps: "live · ", psB: "in aggiornamento" },
  ],
  ...
  pcNote: "Accesso mensile o annuale · Verifica le condizioni di rinnovo al checkout e nel tuo account · Nessun conto bookmaker richiesto · Nessuna scommessa piazzata per te · Nessun rendimento garantito · 18+",
  ...
  pcFreeList: ["3 letture del modello per sport, ogni giorno", "Risultati pubblici e registro prospettico", "Probabilità, quota di mercato e un’anteprima dell’edge", "Senza carta"],
  ...
  pcProList: ["Tutto ciò che c’è in Base, senza tetto giornaliero", "Deep analysis su ogni scheda", "Punteggi live e probabilità pre-partita", "Costruisci una vista di probabilità"],
      ...
      <section className="v-hero"><div className="v-wrap v-grid">
        ...
        <figure className="v-scan" aria-label="Edge Scanner">
          ...
          <div className="v-scan-foot">
            <b>{scanLive && scanCounts ? t.waFootEvents(scanCounts.events, scanCounts.withEdge) + " · " : ""}Edge = model probability − market-implied probability. The pick shows the strongest estimated outcome; close probabilities still carry uncertainty.</b>
          </div>
        </figure>
      </div>
