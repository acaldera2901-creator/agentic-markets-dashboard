"""
Michele's why-v2 contract (lab tests/test_wc_explanation_v2.py @ 34e58fb), ported
to import the PROMOTED core function (core.world_cup_explanation.build_wc_explanation)
instead of the now-removed scripts/proposed_wc_explanation_v2 prototype. Kept as a
distinct file so the lab's 9-case contract stays a named, runnable guard.
"""
