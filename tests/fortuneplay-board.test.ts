...
// #FORTUNEPLAY-DEEPLINK-0701: deep-link costruibile → /{locale}/sports/{sport}/{slug}-m-{id}?stag=
assert.equal(e.matchUrl, "https://www.fortuneplay.com/it/sports/soccer/milan-inter-m-42?stag=AFF1");
assert.equal(e.prefilled, true);

// fallback landing quando manca lo slug/id
const bad: FpMatch = { ...fm, teamPairKey: "k2", slug: "", id: 0 };
const res2 = boardToResponse(new Map([[bad.teamPairKey, bad]]), {
  baseUrl: "https://www.fortuneplay.com", locale: "it", landingUrl: "https://mediaroosters.com/aacugmydl8",
});
