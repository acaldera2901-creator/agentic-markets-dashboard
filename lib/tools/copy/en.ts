  ...
  tools: {
    "odds-converter": {
      ...
      explainer: [
        ...
        "The number worth reading is the last one: implied probability, which is simply 1 divided by the decimal price. A price of 2.50 implies 40%. A price of 1.91 — the familiar −110 — implies 52.38%. This is the bookmaker's stated chance of the outcome, and it is the only number you can compare directly against your own estimate. Two prices in different formats are not easier to compare than two probabilities; convert first, argue second.",
    ...
    "margin-calculator": {
      ...
      labels: {
        ...
        presetTwoWay: "Two-way",
        presetThreeWay: "Three-way",
      ...
      explainer: [
        "A fair two-way market prices both sides at 2.00: the implied probabilities are 50% and 50%, they add to exactly 100%, and neither side has an edge. Real markets are priced at 1.91 and 1.91. Those implied probabilities are 52.38% each, they add to 104.76%, and the extra 4.76 percentage points are the bookmaker's margin — the overround. Whichever side you back, you are paying it.",
    ...
    "probability-calculator": {
      ...
      labels: {
        ...
        parlayFair: "Fair price for that probability",
        resultTitle: "Results",
        hint: "Enter either side of the conversion: the other one follows.",
      },
