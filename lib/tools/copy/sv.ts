  ...
  tools: {
    "odds-converter": {
      ...
      explainer: [
        ...
        "Talet som är värt att läsa är det sista: den implicita sannolikheten, alltså 1 delat med decimaloddset. Ett pris på 2.50 innebär 40 %. Ett pris på 1.91 — den välkända −110 — innebär 52,38 %. Det är den chans spelbolaget uttalar, och det är det enda talet du kan jämföra direkt med din egen uppskattning. Två odds i olika format är inte lättare att jämföra än två sannolikheter: omvandla först, diskutera sedan.",
    ...
    "margin-calculator": {
      ...
      explainer: [
        "En rättvis tvåvägsmarknad prissätter båda sidor till 2.00: de implicita sannolikheterna är 50 % och 50 %, de summerar till exakt 100 %, och ingen sida har någon fördel. Verkliga marknader prissätts till 1.91 och 1.91. De implicita sannolikheterna blir 52,38 % var, summerar till 104,76 %, och de överskjutande 4,76 procentenheterna är spelbolagets marginal — overrounden. Vilken sida du än spelar betalar du den.",
