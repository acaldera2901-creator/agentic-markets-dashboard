  ...
  tools: {
    "odds-converter": {
      ...
      explainer: [
        ...
        "Liczba, którą warto czytać, jest ostatnia: prawdopodobieństwo implikowane, czyli 1 podzielone przez kurs dziesiętny. Cena 2.50 implikuje 40%. Cena 1.9091 — znane −110 — implikuje 52,38%. To prawdopodobieństwo ogłoszone przez bukmachera i jedyna liczba, którą możesz porównać bezpośrednio z własnym oszacowaniem. Dwóch kursów w różnych formatach nie porównuje się łatwiej niż dwóch prawdopodobieństw: najpierw przelicz, potem dyskutuj.",
    ...
    "margin-calculator": {
      ...
      explainer: [
        "Uczciwy rynek dwudrogowy wycenia obie strony na 2.00: prawdopodobieństwa implikowane to 50% i 50%, sumują się dokładnie do 100% i żadna strona nie ma przewagi. Rzeczywiste rynki są wyceniane na 1.90 i 1.90. Te prawdopodobieństwa implikowane wynoszą po 52,63%, sumują się do 105,26%, a nadwyżkowe 5,26 punktu procentowego to marża bukmachera — overround. Którąkolwiek stronę zagrasz, płacisz ją.",
